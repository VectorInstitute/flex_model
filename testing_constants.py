...
_LLAMA_FSDP_MODULE_SHAPES = [
    (3, 11, 4096) for n in range(len(_LLAMA_FSDP_MODULE_NAMES))
]
_LLAMA_FSDP_MODULE_SHAPES[2] = (3, 11, 11008)
_LLAMA_FSDP_MODULE_SHAPES[8] = (3, 11, 11008)
_LLAMA_FSDP_MODULE_SHAPES[9] = (3, 11, 11008)
